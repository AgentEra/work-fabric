...
export async function runPostgresSmoke(options: PostgresSmokeOptions): Promise<{ readonly migrations: number; readonly profiles: readonly string[] }> {
  ...
  try {
    ...
    return { migrations: migration.migrations, profiles: ["exchange.durability.v1", "exchange.projection.v1", "exchange.subscription.v1", "exchange.persistence.v1", "exchange.context.v1", "connector.ingress.v1", "workfabric.collaboration-view.v1", "workfabric.operation-audit.v1", "workfabric.recovery-request.v1", "workfabric.connector-discrepancy.v1", "workfabric.cluster.v1"] };

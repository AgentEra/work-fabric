...
- [x] **Step 1: Add failing contract and source-idempotence tests**
...
- [x] **Step 3: Add the final neutral contracts**
...
- [x] **Step 5: Commit the neutral contract**
...
- [x] **Step 1: Add failing union-validation tests**
...
- [x] **Step 3: Introduce the exact discriminated types**
...
- [x] **Step 4: Make secret paths transport-aware**
...
- [x] **Step 5: Run configuration regressions**
...
- [x] **Step 6: Commit strict transport selection**
...
- [x] **Step 1: Scaffold the package with an exact SDK pin**
...
- [x] **Step 2: Write failing envelope tests**
...
- [x] **Step 4: Implement bounded reconstruction**
...
- [x] **Step 5: Add and test a no-content logger**
...
- [x] **Step 7: Commit the adapter boundary**
...
- [x] **Step 1: Define an internal SDK seam for deterministic tests**
...
- [x] **Step 2: Add failing lifecycle tests with a fake runtime**
...
- [x] **Step 4: Implement the factory and client**
...
- [x] **Step 5: Run adapter tests, typecheck and open-handle check**
...
- [x] **Step 6: Commit lifecycle implementation**
...
- [x] **Step 1: Add failing plugin composition tests**
...
- [x] **Step 2: Confirm RED while preserving Webhook GREEN**
...
- [x] **Step 3: Build the source only for enabled long connection**
...
- [x] **Step 4: Make prepare/start/stop transport-specific**
...
- [x] **Step 5: Separate worker health from connection health**
...
- [x] **Step 6: Run plugin and Connector regressions**
...
- [x] **Step 7: Commit plugin integration**
...
- [x] **Step 1: Add failing role and service-composition tests**
...
- [x] **Step 3: Implement the role helper**
...
- [x] **Step 4: Add the injectable factory to composition**
...
- [x] **Step 5: Verify liveness/readiness semantics**
...
- [x] **Step 6: Run service and role regressions**
...
- [x] **Step 7: Commit Node composition**
...
- [x] **Step 1: Add a full fake client/factory harness**
...
- [x] **Step 2: Write the failing E2E scenario**
...
- [x] **Step 4: Make only integration fixes required by the E2E proof**
...
- [x] **Step 5: Run both transport E2E suites repeatedly**
...
- [x] **Step 4: Prove log redaction and sensitive scan**
...
- [x] **Step 5: Run all boundary checks**
...
- [x] **Step 6: Commit boundary enforcement**
...
- [x] **Step 1: Add the local SQLite long-connection example**
...
- [x] **Step 2: Document the exact local run**
...
- [x] **Step 3: Update architecture and roadmap truthfully**
...
- [ ] **Step 5: Perform the no-domain manual acceptance when credentials are available** — Not executed because live Feishu credentials were not supplied.
...
- [x] **Step 6: Commit documentation and verified status**

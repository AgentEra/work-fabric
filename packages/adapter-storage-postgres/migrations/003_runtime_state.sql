...
CREATE TABLE IF NOT EXISTS work_fabric_projection_failures (
  ...
  recorded_at text NOT NULL, PRIMARY KEY (tenant_id, projector_id, partition_id, event_id, position)
);
...
DO $$ DECLARE table_name text; BEGIN
  FOREACH table_name IN ARRAY ARRAY[
    ...
    'work_fabric_deliveries','work_fabric_delivery_active','work_fabric_worker_leases'] LOOP
